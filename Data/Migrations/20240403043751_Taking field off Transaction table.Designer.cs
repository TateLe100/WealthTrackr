...
namespace WealthTrackr.Data.Migrations
{
    ...
    [Migration("20240403043751_Taking field off Transaction table")]
    partial class TakingfieldoffTransactiontable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WealthTrackr.Areas.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WealthTrackr.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WealthTrackr.Areas.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WealthTrackr.Models.Transaction", b =>
                {
                    b.HasOne("WealthTrackr.Models.Category", "Category")
                        .WithMany()
